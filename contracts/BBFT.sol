/**
 *Submitted for verification at BscScan.com on 2025-07-05
*/
...
contract BBFT is ERC20, Ownable {
    ...
    constructor(
        ...
        maxBuyAmount = totalSupply *  10 / 1000; // 1% of total supply
        maxSellAmount = totalSupply *  10 / 1000; // 1% of total supply
        maxWalletAmount = totalSupply * 20 / 1000; // 2% of total supply
        swapTokensAtAmount = totalSupply * 50 / 100000; // 0.05% of total supply
